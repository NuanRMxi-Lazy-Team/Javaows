...
import cn.moerain.javaows.office.*;
import cn.moerain.javaows.applications.*;
import cn.moerain.javaows.system.*;
import cn.moerain.javaows.misc.*;
...
public class ToolLauncher extends JFrame {
    ...
    private void createMenuBar() {
        ...
        editMenu.add(createMenuItem(Localization.t("menu.editTools.NotePad", "文本编辑器"), 'T', this::launchNotePad));
    ...
    private void createToolBar() {
        ...
        // 添加工具按钮
        toolBar.add(createToolButton(Localization.t("toolbar.NotePad", "文本编辑器"), this::launchNotePad));
    ...
    private void showStartMenu(ActionEvent e) {
        ...
        editSubmenu.add(createMenuItem(Localization.t("menu.editTools.NotePad", "文本编辑器"), 'T', this::launchNotePad));
    ...
    // 工具启动方法
    private void launchNotePad(ActionEvent e) {
    ...
    private void launchMinecraftViewer(ActionEvent e) {
        createInternalFrame("Minecraft 版本查看器", "🎮", () -> {
            VersionViewer viewer = new VersionViewer();
    ...
    private void launchTaskmgr(ActionEvent e) {
        createInternalFrame("任务管理器", "🛠️", () -> {
            TaskMgr taskManager = new TaskMgr();
